...
This project is now updated to work with ruby 2.3.0. <br />
1) Update Java to 1.8.0. Make sure JAVA_HOME is pointing at correct java sdk folder.<br />
...
Input : {"Reviews":"The  article clearly describes its intentions. I felt that section 3 could have been elaborated a little more"}<br />
Output: {"volume":"15"}
<br />
2) Tone<br />
