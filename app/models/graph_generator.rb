...
def append_to_previous(count,term,plainToken,iteration,labels,labelCounter)
  prevVertex = search_vertices(@vertices, term[count], iteration)#fetching the previous vertex
  term[count] = term[count] + " " + plainToken#concatenating with contents of the previous vertex
